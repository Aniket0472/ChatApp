...
import static com.example.chatapp.R.id.buttonGetOTP;
import static com.example.chatapp.R.id.textMobile;
...
public class VerifyOTP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ResndOTP).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
